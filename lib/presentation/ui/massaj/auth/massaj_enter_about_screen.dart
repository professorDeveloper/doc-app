...
class MassajEnterAboutScreen extends StatefulWidget {
  final VoidCallback onNext;

  MassajEnterAboutScreen({required this.onNext});

  @override
  State<MassajEnterAboutScreen> createState() => _SmallDoctorEnterAboutScreenState();
}

class _SmallDoctorEnterAboutScreenState extends State<MassajEnterAboutScreen>  with AutomaticKeepAliveClientMixin{
