...
import 'package:doc_app/presentation/ui/massaj/auth/massaj_add_data_dialog.dart';
import 'package:doc_app/presentation/ui/massaj/auth/massaj_edit_dialog.dart';
...
import '../../kichikhodim/auth/finished_success_dialog.dart';
import 'massaj_edit_other_documents.dart';

class MassajEnterProfessionScreen extends StatefulWidget {
  const MassajEnterProfessionScreen({super.key});

  @override
  State<MassajEnterProfessionScreen> createState() => _SmallDoctorEnterProfessionScreenState();
}

class _SmallDoctorEnterProfessionScreenState extends State<MassajEnterProfessionScreen> {
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: MaterialButton(
                        ...
                        onPressed: () {
                          massajShowAddDataDialog(context, (dataModel) {
