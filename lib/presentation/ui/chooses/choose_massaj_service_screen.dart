...
class ChooseMassajServiceScreen extends StatefulWidget {
  const ChooseMassajServiceScreen({super.key});

  @override
  State<ChooseMassajServiceScreen> createState() => _ChooseServiceScreenState();
}

class _ChooseServiceScreenState extends State<ChooseMassajServiceScreen> {
  int? _selectedValue = 0;
  List<String> services=["Miyya massaji","Oyoq Massaji","Tez massaji","Uy massaji"];
