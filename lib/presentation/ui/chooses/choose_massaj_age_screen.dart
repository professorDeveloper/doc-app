...
import 'package:doc_app/presentation/ui/chooses/choose_massaj_service_screen.dart';
...
class ChooseMassajAgeScreen extends StatefulWidget {
  const ChooseMassajAgeScreen({super.key});

  @override
  State<ChooseMassajAgeScreen> createState() => _ChooseAgeScreenState();
}

class _ChooseAgeScreenState extends State<ChooseMassajAgeScreen> {
                    ...
                    child: MaterialButton(
                      ...
                      onPressed: _selectedValue == 0
                          ...
                          : () {
                              ...
                              openScreen(context, ChooseMassajServiceScreen());
                            },
                      elevation: 0,
